...
const SITE_DEFS: Record<string, { codes: string[]; region: string }> = {
  ...
  'Piedras Negras': { codes: ['PNG','PNGS','PNGP','PNGA'], region: 'Usmacinta' },
  'Tonina': { codes: ['TNAM'], region: 'Central' },
  'Yaxchilan': { codes: ['YAX','YAXL','YAXS','YAXHS'], region: 'Usmacinta' },
  'Palenque': { codes: ['PAL','PALT','PALTI','PALPT','PALTC','PALTFC','PALTS','PALTCI','PALKTT'], region: 'Usmacinta' },
  ...
  'Tortuguero': { codes: ['TRT','TRTM'], region: 'Usmacinta' },
  ...
  'Moral-Reforma': { codes: ['MRL','MRLS'], region: 'Usmacinta' },
  'Aguateca': { codes: ['AGT','AGTS'], region: 'Central' },
  'Altar de Sacrificios': { codes: ['ALS','ALSS'], region: 'Usmacinta' },
  'Bonampak': { codes: ['BPK','BPKM','BPKSS','BKPKOKV'], region: 'Usmacinta' },
