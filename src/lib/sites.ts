...
type Region = 'North' | 'East' | 'Central' | 'Usumacinta' | 'South' | 'Unknown';
...
const SITES: Record<string, SiteData> = {
  ...
  'Piedras Negras': { lat: 17.1500, lng: -91.0167, region: 'Usumacinta', country: 'Guatemala' },
  'Tonina': { lat: 16.9033, lng: -92.0108, region: 'Central', country: 'Mexico' },
  'Yaxchilan': { lat: 16.8989, lng: -91.0000, region: 'Usumacinta', country: 'Mexico' },
  'Palenque': { lat: 17.4839, lng: -92.0460, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Tortuguero': { lat: 17.5000, lng: -92.9500, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Moral-Reforma': { lat: 18.0500, lng: -91.7667, region: 'Usumacinta', country: 'Mexico' },
  'Aguateca': { lat: 16.4500, lng: -90.1833, region: 'Central', country: 'Guatemala' },
  'Altar de Sacrificios': { lat: 16.4667, lng: -90.8000, region: 'Usumacinta', country: 'Guatemala' },
  'Bonampak': { lat: 16.7050, lng: -91.0658, region: 'Usumacinta', country: 'Mexico' },
  ...
  'La Pasadita': { lat: 16.9500, lng: -91.0500, region: 'Usumacinta', country: 'Guatemala' },
  ...
  'La Mar': { lat: 16.8667, lng: -91.5333, region: 'Usumacinta', country: 'Mexico' },
  'Pomoná': { lat: 17.6333, lng: -91.5833, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Sak Tz\'i\'': { lat: 16.7167, lng: -91.7500, region: 'Usumacinta', country: 'Mexico' },
  'Lacanha': { lat: 16.7500, lng: -91.1333, region: 'Usumacinta', country: 'Mexico' },
  ...
  'El Cayo': { lat: 16.9667, lng: -91.1167, region: 'Usumacinta', country: 'Guatemala' },
  ...
  'Pomona': { lat: 17.6333, lng: -91.5833, region: 'Usumacinta', country: 'Mexico' },
  'Lacanja Tzeltal': { lat: 16.7500, lng: -91.1333, region: 'Usumacinta', country: 'Mexico' },
  ...
  'La Mancha': { lat: 17.3000, lng: -91.2000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'La Gloria': { lat: 16.8500, lng: -91.0000, region: 'Usumacinta', country: 'Guatemala' },
  ...
  'Santa Elena Poco Uinic': { lat: 16.6000, lng: -91.5000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Obregon': { lat: 17.5000, lng: -91.5000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Joloniel': { lat: 17.0000, lng: -92.0000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Chinikiha': { lat: 17.3500, lng: -91.7000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Jonuta': { lat: 18.0800, lng: -92.1300, region: 'Usumacinta', country: 'Mexico' },
  'Chuncanob': { lat: 19.9000, lng: -89.6000, region: 'North', country: 'Mexico' },
  'Altamira': { lat: 17.4000, lng: -91.6000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Santo Domingo': { lat: 17.1000, lng: -91.5000, region: 'Usumacinta', country: 'Mexico' },
  'El Palma': { lat: 17.5000, lng: -90.0000, region: 'Central', country: 'Guatemala' },
  'El Kinel': { lat: 16.9000, lng: -91.0000, region: 'Usumacinta', country: 'Guatemala' },
  ...
  'Chancala': { lat: 17.3000, lng: -91.9000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Lopez Mateos': { lat: 17.5000, lng: -91.5000, region: 'Usumacinta', country: 'Mexico' },
  'Kayal': { lat: 17.3000, lng: -91.3000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Bellote': { lat: 18.2000, lng: -93.2000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Xupa': { lat: 17.0000, lng: -91.5000, region: 'Usumacinta', country: 'Mexico' },
  'Xtablakal': { lat: 18.5000, lng: -89.5000, region: 'Central', country: 'Mexico' },
  'Xnaheb': { lat: 16.2000, lng: -89.0000, region: 'East', country: 'Belize' },
  'Tzendales': { lat: 16.8000, lng: -91.3000, region: 'Usumacinta', country: 'Mexico' },
  ...
  'Ojo de Agua Chiapas': { lat: 17.0000, lng: -93.0000, region: 'Usumacinta', country: 'Mexico' },
  'San Jose': { lat: 17.2000, lng: -89.0000, region: 'East', country: 'Belize' },
  'El Caribe': { lat: 17.0000, lng: -89.1000, region: 'East', country: 'Belize' },
  'San Pedro': { lat: 17.5000, lng: -91.3000, region: 'Usumacinta', country: 'Mexico' },
