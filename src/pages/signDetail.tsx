    ...
    <div className="max-w-[80ch] mx-auto px-4 py-4">
      <div className="flex flex-col gap-4">
        ...
        {activeTab === 'concordance' && (
          crossRefs.length === 0 ? (
            <table className="w-full"><tbody><tr><td className="px-3 py-1 text-xs text-center">No cross-references found in concordance tables</td></tr></tbody></table>
          ) : (
            <table className="w-full">
              <thead>
                <tr>
        ...
        {activeTab === 'variants' && (
          graphVariants.length === 0 ? (
            <table className="w-full"><tbody><tr><td className="px-3 py-1 text-xs text-center">No visual variants available</td></tr></tbody></table>
          ) : (
            <table className="w-full">
              <thead>
                <tr>
        ...
        {activeTab === 'examples' && (
          roboflow.length === 0 ? (
            <table className="w-full"><tbody><tr><td className="px-3 py-1 text-xs text-center">No ML training examples available</td></tr></tbody></table>
          ) : (
            <table className="w-full">
              <thead>
                <tr>
