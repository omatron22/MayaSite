...
export function AboutPage() {
  ...
  const dataSources: Source[] = [
    ...
    {
      title: 'Thompson 1962 — A Catalog of Maya Hieroglyphs',
      desc: '400 of 854 T-numbers hydrated with original glyph names (e.g. T17 = "Yax"), example counts, and Gates/Zimmermann cross-references from J.E.S. Thompson\'s 1962 catalog. Out of print; FAMSI hosts a permissioned PDF for scholarly study.',
      license: 'Copyright Univ. of Oklahoma Press 1962. Out of print. FAMSI hosts permissioned PDF; cite the original.',
      attribution: 'J. Eric S. Thompson, "A Catalog of Maya Hieroglyphs" (Norman: Univ. of Oklahoma Press, 1962).',
      images: 'none',
      url: 'https://www.famsi.org/mayawriting/thompson/ThompsonGlyphCatalog.pdf',
    },
    {
      title: 'FAMSI Montgomery Drawing Collection',
      desc: '572 of 718 John Montgomery line drawings of Maya monuments, scraped from FAMSI. 289 auto-linked to existing place entities (Piedras Negras 161, Tikal 35, Palenque 14, others).',
      license: 'Copyright © John Montgomery. Hosted by FAMSI/LACMA for scholarly use.',
      attribution: 'John Montgomery; drawings hosted by FAMSI (research.famsi.org/montgomery_list.php) under LACMA stewardship.',
      images: 'linked',
      url: 'http://research.famsi.org/montgomery_list.php',
    },
    {
      title: 'Linda Schele Drawing Collection (LACMA/AncientAmericas)',
      desc: '886 Linda Schele drawings of Maya inscriptions with rich metadata: object number, site, period, culture, archaeological phase, bibliography. 615 auto-linked to existing place entities (Palenque 214, Copan 101, Chichen Itza 76, Tikal 60).',
      license: 'Copyright LACMA. Freely available for scholarly study and academic publication; publication-quality assets via rights@lacma.org.',
      attribution: 'Linda Schele; drawings hosted by LACMA / AncientAmericas.org as the FAMSI successor.',
      images: 'linked',
      url: 'https://www.ancientamericas.org/collection/browse/29',
    },
    {
