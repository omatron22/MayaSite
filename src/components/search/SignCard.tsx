  ...
  >
    <div className="w-12 h-12 mx-auto mt-3 bg-gray-50 flex items-center justify-center">
      {sign.primary_image_url ? (
        <img src={sign.primary_image_url} alt={sign.display_code} loading="lazy" className="max-w-full max-h-full object-contain" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
      ) : (
